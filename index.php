                ...
                <div class="col-sm-7">
                    <div class="header-content">
                        <div class="header-content-inner">
                            <h1>Mutya Publishing!</h1>
                            <a href="register.php" class="btn btn-outline btn-xl page-scroll">Register!</a>
                           <!-- <a href="#" class="btn btn-outline btn-xl page-scroll">Register as Company!</a> -->
                        </div>
                    </div>
                </div>
                <div class="col-sm-5">
                        ...
                        <div class="">
                            <div class="device">
                                <div class="screen">
                                    ...
                                    <img src="img/201.png" class="img-responsive" alt="">
                                </div>
                                <div class="button">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="img/bg-cta.jpg" alt="Chania">
...
<?php 
    ...
    <div class="col-sm-4">
        <div class="thumbnail">
          <img src="img/product_image/'.$id.'.'.$ext.'" alt="'.$title.'" width="150" height="100">
      
          <a href="details.php?pid='.$id.'"><button class="btn" data-toggle="modal" data-target="">DETAIL</button></a>
        </div>
      </div>
				';
										}
