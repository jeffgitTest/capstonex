...
<ul class="nav nav-pills">
  <li class="active"><a href="#home" data-toggle="tab">Shopping Cart</a></li>
...
<div class="tab-content">
  ...
  <div class="table-responsive">
          ...
          <thead>
           ...
           <div class="span3"><h4 align="text-center"><?php echo $cart_Total ?><//h4> </div>
      </div>
