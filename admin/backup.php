    ...
    <body>
        ...
        <table border="0" bgcolor="#C0C0C0" align="center" width="40%">
            ...
            <tr>
                <td>MySQL host*</td>
                <td>:</td>
                <td><input type="password" id="host" name="host" value="localhost"/></td>
            </tr>
            <tr>
                <td>MySQL username*</td>
                <td>:</td>
                <td><input type="password" id="username" name="username" value="root"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="password" id="databasename" name="databasename" value="capstone"/></td>
            </tr>
            <tr>
